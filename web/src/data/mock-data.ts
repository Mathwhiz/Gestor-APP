export const summaries = [
  {
    title: "Ingresos hoy",
    value: "$ 480.000",
    detail: "Honorarios cobrados y una seña de agencia.",
    accent: "#1f4f5f",
  },
  {
    title: "Egresos hoy",
    value: "$ 126.000",
    detail: "Formularios, combustible y comision de tercero.",
    accent: "#b57628",
  },
  {
    title: "Tramites urgentes",
    value: "6",
    detail: "Dos observados y cuatro con documentacion faltante.",
    accent: "#ad5f47",
  },
  {
    title: "Cobros pendientes",
    value: "$ 1.280.000",
    detail: "Distribuidos entre gestoria y agencia.",
    accent: "#2b6f55",
  },
];
...
export const procedures = [
  {
    ...
    vehicle: "Ford Ranger 2019 · AE918KD",
    status: "Pendiente de documentacion",
  ...
  },
  {
    ...
    vehicle: "Volkswagen Gol 2016 · AC345TR",
    status: "Presentado",
  ...
  },
  {
    ...
    client: "Agencia Ruta 5",
    vehicle: "Peugeot 208 2020 · AG552LM",
    status: "Terminado",
  ...
  {
    id: "patentamiento-yaris",
    type: "Patentamiento",
    client: "Lucia Perez",
    vehicle: "Toyota Yaris 0km · sin dominio",
    status: "Observado",
...
export const guides = [
  {
    id: "guide-1",
    title: "Transferencia",
    summary: "Checklist base, pasos de control y links utiles para no dejar firmas o verificaciones afuera.",
    scope: "Base",
  ...
  },
  {
    ...
    summary: "Guia corta para documentacion requerida, observaciones comunes y validaciones previas.",
    scope: "Base",
    jurisdiction: "Nacional",
  ...
  },
  {
    ...
    summary: "Resumen de pasos, papeles y criterio interno para evitar rechazos o entregas incompletas.",
    scope: "Interna",
...
export const vehicles = [
  ...
  },
  {
    ...
    owner: "Mariana Lopez",
    area: "Gestoria",
    status: "Documentacion incompleta",
    tone: "danger" as const,
...
export const procedureDetails: Record<string, ProcedureDetail> = {
  "transferencia-ranger": {
    ...
    summary: [
      { label: "Estado", value: "Pendiente de documentacion", tone: "warning" as const },
      { label: "Prioridad", value: "Urgente", tone: "danger" as const },
