...
export default async function LoginPage({
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="grid w-full max-w-4xl overflow-hidden rounded-[32px] border border-[var(--color-line)] bg-white shadow-[0_24px_80px_rgba(17,24,39,0.08)] lg:grid-cols-[1fr_0.95fr]">
        <section className="flex flex-col justify-center bg-[linear-gradient(135deg,#1f4f5f_0%,#17343f_60%,#11242c_100%)] p-8 text-white sm:p-12">
          <div className="space-y-6">
            ...
            <div className="max-w-xl space-y-4">
              ...
              <p className="max-w-lg text-sm leading-7 text-white/72 sm:text-base">
                Una base simple para seguir tramites, clientes, vehiculos, tareas y caja sin
                depender de memoria o planillas sueltas.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-md space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm leading-6 text-[var(--color-muted)]">
                Entrá con tu Gmail habilitado para seguir trabajando.
              </p>
            </div>
